...
namespace W3development\ExportOrders\Model\Export\Adapter;
...
class Array2XML extends \Magento\Framework\Model\AbstractModel
{
   ...
   *
  **/
  function init( $version='1.0', $encoding='UTF-8', $formatOutput=true )
  {
   ...
   *
  **/
  function setTopNodeName($topNodeName)
  {
    if( ! $this->xml )
      $this->init();
   ...
   *
  **/
  function importArray( $data=array() )
  {
  ...
  **/
  ...
  function __tostring() { return $this->saveXml(); }

  /*
   *
   * @param string $path - name of the root node to be converted
   * @return DOMNode
  **/
  function saveTo()
  {
    return $this->xml->save("/var/www/magento.w3development.net/public_html/var/feeds/test.xml");
  }
}
